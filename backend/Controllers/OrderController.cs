...
namespace TEST_CRUD.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        [HttpGet("/api/id")]
        public async Task<ActionResult<ServiceResponse<GetOrderDto>>> GetSingle(string id)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<ActionResult<ServiceResponse<GetOrderDto>>> UpdateOrderStatus(string id, string status)
        {
            try
            {
