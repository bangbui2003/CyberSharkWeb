...
namespace TEST_CRUD.Services.Orders
{
    public class OrderService : IOrderService
    {
        ...
        public async Task<ServiceResponse<IEnumerable<GetOrderDto?>>> GetByCustomerId(int customerId)
        {
            var orderList = await _repo.GetByCustomerId(customerId);
        ...
        public async Task<ServiceResponse<GetOrderDto?>> GetById(string orderid)
        {
            ServiceResponse<GetOrderDto> response = new ServiceResponse<GetOrderDto>();
        ...
        public async Task<ServiceResponse<GetOrderDto?>> UpdateOrderStatus(string id, string status)
        {
            ServiceResponse<GetOrderDto> response = new ServiceResponse<GetOrderDto>();
