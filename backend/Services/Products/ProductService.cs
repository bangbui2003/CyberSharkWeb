...
namespace TEST_CRUD.Services
{
    public class ProductService : IProductService
    {
        ...
        public async Task<ServiceResponse<IEnumerable<GetProductDto?>>> GetList(string search)
        {
            var productList = await _repo.GetList(search);
        ...
        public async Task<ServiceResponse<GetProductDto>> Add(AddProductDto product)
        {
            ...
            var checkName = await _repo.GetList(mapProduct.Name);
